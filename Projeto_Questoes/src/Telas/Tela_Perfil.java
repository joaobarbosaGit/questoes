...
public class Tela_Perfil extends javax.swing.JDialog {
    ...
    public Tela_Perfil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        PreencherCampos();
    }
    ...
    public void PreencherCampos(){
        ...
        tf_email.setText(ut.getEmail());
        tf_nome.setText(ut.getNome());
        jpf_senha.setText(ut.getSenha());
    }
    ...
    private void bt_atualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_atualizarActionPerformed
        if (JOptionPane.showConfirmDialog(null, "Deseja Atualizar?", "Atualizar", 2) == 0) {
            ...
            uawdao.BuscarUsuarioAlunoIdEquipe(ua, ut.getEquipe_idEquipe());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tela_Perfil dialog = new Tela_Perfil(new javax.swing.JFrame(), true);
